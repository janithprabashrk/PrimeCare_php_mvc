    ...
    <table class="listing-table-for-customer-payments">
        ...
        <tbody>
            <tr data-href="">
                ...
                <td><span class="border-button-sm green">Generate Receipt</span></td>
            </tr>
            <tr data-href="">
                <td>2024/09/11</td>
                <td>RT001</td>
                ...
                <td><span class="border-button-sm orange">Proceed to Pay</span></td>
            </tr>
            <tr data-href="">
                <td>2024/09/3</td>
                <td>RT001</td>
...
<script>
    ...
    document.getElementById('earnings-header').addEventListener('click', function() {
        ...
        isEarningsAscending = !isEarningsAscending;
    });
